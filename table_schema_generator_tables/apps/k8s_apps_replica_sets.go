...
type TableK8sAppsReplicaSetsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sAppsReplicaSetsGenerator{}

func (x *TableK8sAppsReplicaSetsGenerator) GetTableName() string {
	return "k8s_apps_replica_sets"
}

func (x *TableK8sAppsReplicaSetsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sAppsReplicaSetsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sAppsReplicaSetsGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableK8sAppsReplicaSetsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).K8sServices().ReplicaSets
...
func (x *TableK8sAppsReplicaSetsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sAppsReplicaSetsGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("status_fully_labeled_replicas").ColumnType(schema.ColumnTypeInt).
...
func (x *TableK8sAppsReplicaSetsGenerator) GetSubTables() []*schema.Table {
	return nil
}
