...
type TableK8sNodesRuntimeClassesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sNodesRuntimeClassesGenerator{}

func (x *TableK8sNodesRuntimeClassesGenerator) GetTableName() string {
	return "k8s_nodes_runtime_classes"
}

func (x *TableK8sNodesRuntimeClassesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sNodesRuntimeClassesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sNodesRuntimeClassesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sNodesRuntimeClassesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().NodeV1().RuntimeClasses()
...
func (x *TableK8sNodesRuntimeClassesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sNodesRuntimeClassesGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("overhead").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("Overhead")).Build(),
...
func (x *TableK8sNodesRuntimeClassesGenerator) GetSubTables() []*schema.Table {
	return nil
}
