...
type TableK8sRbacClusterRoleBindingsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sRbacClusterRoleBindingsGenerator{}

func (x *TableK8sRbacClusterRoleBindingsGenerator) GetTableName() string {
	return "k8s_rbac_cluster_role_bindings"
}

func (x *TableK8sRbacClusterRoleBindingsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sRbacClusterRoleBindingsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sRbacClusterRoleBindingsGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sRbacClusterRoleBindingsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().RbacV1().ClusterRoleBindings()
...
func (x *TableK8sRbacClusterRoleBindingsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sRbacClusterRoleBindingsGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("subjects").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("Subjects")).Build(),
		...
		table_schema_generator.NewColumnBuilder().ColumnName("role_ref").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("RoleRef")).Build(),
...
func (x *TableK8sRbacClusterRoleBindingsGenerator) GetSubTables() []*schema.Table {
	return nil
}
