...
type TableK8sRbacRolesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sRbacRolesGenerator{}

func (x *TableK8sRbacRolesGenerator) GetTableName() string {
	return "k8s_rbac_roles"
}

func (x *TableK8sRbacRolesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sRbacRolesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sRbacRolesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sRbacRolesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().RbacV1().Roles("")
...
func (x *TableK8sRbacRolesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sRbacRolesGenerator) GetColumns() []*schema.Column {
...
func (x *TableK8sRbacRolesGenerator) GetSubTables() []*schema.Table {
	return nil
}
