...
type TableK8sRbacRoleBindingsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sRbacRoleBindingsGenerator{}

func (x *TableK8sRbacRoleBindingsGenerator) GetTableName() string {
	return "k8s_rbac_role_bindings"
}

func (x *TableK8sRbacRoleBindingsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sRbacRoleBindingsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sRbacRoleBindingsGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sRbacRoleBindingsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().RbacV1().RoleBindings("")
...
func (x *TableK8sRbacRoleBindingsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sRbacRoleBindingsGenerator) GetColumns() []*schema.Column {
...
func (x *TableK8sRbacRoleBindingsGenerator) GetSubTables() []*schema.Table {
	return nil
}
