...
type TableK8sCoreNamespacesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sCoreNamespacesGenerator{}

func (x *TableK8sCoreNamespacesGenerator) GetTableName() string {
	return "k8s_core_namespaces"
}

func (x *TableK8sCoreNamespacesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sCoreNamespacesGenerator) GetVersion() uint64 {
	return 0
}
...
func (x *TableK8sCoreNamespacesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
...
func (x *TableK8sCoreNamespacesGenerator) GetSubTables() []*schema.Table {
	return nil
}
