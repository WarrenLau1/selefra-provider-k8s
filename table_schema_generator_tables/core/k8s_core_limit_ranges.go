...
type TableK8sCoreLimitRangesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sCoreLimitRangesGenerator{}

func (x *TableK8sCoreLimitRangesGenerator) GetTableName() string {
	return "k8s_core_limit_ranges"
}

func (x *TableK8sCoreLimitRangesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sCoreLimitRangesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sCoreLimitRangesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sCoreLimitRangesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().CoreV1().LimitRanges("")
...
func (x *TableK8sCoreLimitRangesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sCoreLimitRangesGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("spec_limits").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("Spec.Limits")).Build(),
...
func (x *TableK8sCoreLimitRangesGenerator) GetSubTables() []*schema.Table {
	return nil
}
