...
func createServiceAccounts(t *testing.T, ctrl *gomock.Controller) kubernetes.Interface {
	...
	serviceClient.EXPECT().ServiceAccounts(constants.Constants_38).AnyTimes().Return(resourceClient)
...
func TestServiceAccounts(t *testing.T) {
	...
	k8s_client.MockTestHelper(t, table_schema_generator.GenTableSchema(&TableK8sCoreServiceAccountsGenerator{}), createServiceAccounts, k8s_client.TestOptions{})
}
