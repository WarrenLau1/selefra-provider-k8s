...
func createEvents(t *testing.T, ctrl *gomock.Controller) kubernetes.Interface {
	...
	serviceClient.EXPECT().Events(constants.Constants_26).AnyTimes().Return(resourceClient)
...
func TestEvents(t *testing.T) {
	k8s_client.MockTestHelper(t, table_schema_generator.GenTableSchema(&TableK8sCoreEventsGenerator{}), createEvents, k8s_client.TestOptions{})
