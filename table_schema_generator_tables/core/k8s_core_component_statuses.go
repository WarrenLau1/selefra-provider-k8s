...
type TableK8sCoreComponentStatusesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sCoreComponentStatusesGenerator{}

func (x *TableK8sCoreComponentStatusesGenerator) GetTableName() string {
	return "k8s_core_component_statuses"
}

func (x *TableK8sCoreComponentStatusesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sCoreComponentStatusesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sCoreComponentStatusesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sCoreComponentStatusesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().CoreV1().ComponentStatuses()
...
func (x *TableK8sCoreComponentStatusesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sCoreComponentStatusesGenerator) GetColumns() []*schema.Column {
...
func (x *TableK8sCoreComponentStatusesGenerator) GetSubTables() []*schema.Table {
	return nil
}
