...
type TableK8sCoreEndpointsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sCoreEndpointsGenerator{}

func (x *TableK8sCoreEndpointsGenerator) GetTableName() string {
	return "k8s_core_endpoints"
}

func (x *TableK8sCoreEndpointsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sCoreEndpointsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sCoreEndpointsGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sCoreEndpointsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().CoreV1().Endpoints("")
...
func (x *TableK8sCoreEndpointsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sCoreEndpointsGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("subsets").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("Subsets")).Build(),
	}
}

func (x *TableK8sCoreEndpointsGenerator) GetSubTables() []*schema.Table {
	return nil
}
