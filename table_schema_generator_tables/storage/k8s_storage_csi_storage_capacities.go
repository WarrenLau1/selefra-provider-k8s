...
type TableK8sStorageCsiStorageCapacitiesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sStorageCsiStorageCapacitiesGenerator{}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetTableName() string {
	return "k8s_storage_csi_storage_capacities"
}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().StorageV1().CSIStorageCapacities("")
...
func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("node_topology").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("NodeTopology")).Build(),
		...
		table_schema_generator.NewColumnBuilder().ColumnName("storage_class_name").ColumnType(schema.ColumnTypeString).
			Extractor(column_value_extractor.StructSelector("StorageClassName")).Build(),
		...
		table_schema_generator.NewColumnBuilder().ColumnName("maximum_volume_size").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("MaximumVolumeSize")).Build(),
	}
}

func (x *TableK8sStorageCsiStorageCapacitiesGenerator) GetSubTables() []*schema.Table {
	return nil
}
