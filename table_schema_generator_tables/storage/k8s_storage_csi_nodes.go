...
type TableK8sStorageCsiNodesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sStorageCsiNodesGenerator{}

func (x *TableK8sStorageCsiNodesGenerator) GetTableName() string {
	return "k8s_storage_csi_nodes"
}

func (x *TableK8sStorageCsiNodesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sStorageCsiNodesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sStorageCsiNodesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sStorageCsiNodesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().StorageV1().CSINodes()
...
func (x *TableK8sStorageCsiNodesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sStorageCsiNodesGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("spec_drivers").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("Spec.Drivers")).Build(),
...
func (x *TableK8sStorageCsiNodesGenerator) GetSubTables() []*schema.Table {
	return nil
}
