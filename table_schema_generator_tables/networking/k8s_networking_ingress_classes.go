...
type TableK8sNetworkingIngressClassesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sNetworkingIngressClassesGenerator{}

func (x *TableK8sNetworkingIngressClassesGenerator) GetTableName() string {
	return "k8s_networking_ingress_classes"
}

func (x *TableK8sNetworkingIngressClassesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sNetworkingIngressClassesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sNetworkingIngressClassesGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sNetworkingIngressClassesGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().NetworkingV1().IngressClasses()
...
func (x *TableK8sNetworkingIngressClassesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sNetworkingIngressClassesGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("spec_parameters").ColumnType(schema.ColumnTypeJSON).
			Extractor(column_value_extractor.StructSelector("Spec.Parameters")).Build(),
		...
		table_schema_generator.NewColumnBuilder().ColumnName("spec_controller").ColumnType(schema.ColumnTypeString).
			Extractor(column_value_extractor.StructSelector("Spec.Controller")).Build(),
...
func (x *TableK8sNetworkingIngressClassesGenerator) GetSubTables() []*schema.Table {
	return nil
}
