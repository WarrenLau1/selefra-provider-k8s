...
type TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator{}

func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetTableName() string {
	return "k8s_admissionregistration_mutating_webhook_configurations"
}

func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			cl := client.(*k8s_client.Client).Client().AdmissionregistrationV1().MutatingWebhookConfigurations()
...
func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return k8s_client.ContextExpand()
}

func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetColumns() []*schema.Column {
...
func (x *TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator) GetSubTables() []*schema.Table {
	return nil
}
