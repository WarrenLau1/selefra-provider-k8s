...
func createMutatingWebhookConfigurations(t *testing.T, ctrl *gomock.Controller) kubernetes.Interface {
	...
	serviceClient.EXPECT().MutatingWebhookConfigurations().AnyTimes().Return(resourceClient)
...
func TestMutatingWebhookConfigurations(t *testing.T) {
	k8s_client.MockTestHelper(t, table_schema_generator.GenTableSchema(&TableK8sAdmissionregistrationMutatingWebhookConfigurationsGenerator{}), createMutatingWebhookConfigurations, k8s_client.TestOptions{})
}
