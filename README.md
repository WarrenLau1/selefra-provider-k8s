# Selefra Provider K8S

Use this repo as a raw reference to **tables and schema** for K8S usage. [Here's](https://github.com/selefra/selefra-provider-k8s/blob/main/docs/tables/k8s.md) a summary of full coverage.
